...
if __name__ == "__main__":
    ...
    # parser.add_argument('-sn', default=2000, type=int, help='total training Epochs')
    parser.add_argument('-N', default=50, type=int, help='total training Epochs')
    ...
    parser.add_argument('-out_dim', default=2500, type=int, help='sampling learning rate (default for pruning)')
