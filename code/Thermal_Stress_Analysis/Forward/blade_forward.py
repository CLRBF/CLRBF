...
if __name__ == "__main__":
    ...
    parser.add_argument('-Ntrain', default=99, type=int, help='number of training (x_1_i,x_2_i) points')
    parser.add_argument('-sigma', default=2500, type=int, help='kernel parameter')
    parser.add_argument('-testnumber', default=0, type=int, help='kernel parameter')
    ...
    train_x = train_x['X_test'][n:num_train,:]
    training_beta = torch.zeros((num_train-n,N,1)).to(device)
